...
Simulations of the $n$-DVCS reaction were run to evaluate the efficiency of the CND for neutrons and its angular and momentum resolutions. 
%Neutrons and photons of momenta varying between 0.1 and 1~GeV and having polar angles $\theta$ between $50^\circ$ and $70^\circ$ were generated at a fixed azimuthal angle ($\phi = 3.75^\circ$). Several values of energy thresholds, between 1 and 5 MeV, were studied.
\begin{figure}[htb]  
\begin{center}
...
angular size of each bar $\Delta\phi$=7.5$^{\circ}$, %\begin{eqnarray} 
...
%\caption {Efficiency for the detection of photons, as a function of photon momentum, for a 3-MeV threshold on the deposited energy. The efficiency is shown for $\theta_{\gamma}=60^\circ$. }
%\label{eff_photons}
%\end{center}
%\end{figure}
