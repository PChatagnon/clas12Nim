...
There are two different algorithms to find $t_{\rm{LR}}$ depending if the data were taken with or without magnetic field of the solenoid. 
\begin{itemize}
...
The half time difference can be written as in Eq.~\ref{eq_15}. 
%\begin{equation}
