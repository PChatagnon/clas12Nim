...
\title{The CLAS12 Ring Imaging Cherenkov Detector}
%\author{ }
%\date{November 2019}
...
\address[a]{INFN Sezione di Ferrara and University of Ferrara, 44100 Ferrara, Italy}
\address[b]{INFN Laboratori Nazionali di Frascati, 00044 Frascati, Italy}
\address[c]{INFN Sezione di Roma1 - Gruppo Collegato Sanit\`a and Italian National Institute of Health, 00153 Rome, Italy}
\address[d]{INFN Sezione di Genova, 16146 Genova, Italy}
\address[e]{INFN Sezione di Bari, 70126 Bari, Italy}
\address[f]{Thomas Jefferson National Accelerator Facility, Newport News, VA, 23606 USA}
\address[g]{Argonne National Laboratory, Lemont, IL, 60439 USA}
\address[h]{Duquesne University, Pittsburgh, PA, 15282  USA}
\address[i]{University of Connecticut, Storrs, CT, 06269 USA}
\address[j]{The George Washington University, Washington, DC, 20052 USA}
\address[k]{Universidad T\'ecnica Federico Santa Mar\'ia, Casilla 110-V Valpara\'iso, Chile}
...
instrumented by the photon detectors to $\sim$1~m$^2$ per sector, minimizing costs and influence on the FTOF and
...
individual pixel illumination, and a motorized neutral0density filter system. The laser light is directed through the
...
\begin{figure}[bth]
	...
	\caption{Sampled H8500 \MaPMT single photoelectron spectrum from one of the pixels at 1000~V with a low-intensity
          ...
          to a PMT gain of $2.0 \times 10^6$.
          %The parameter
...
\begin{figure}[ht]
	...
	\caption{Sampled H12700 \MaPMT single photoelectron spectrum from one of the pixels at 1000~V with a low-intensity
          ...
          to a PMT gain of $1.5 \times 10^6$.
          %The parameter
...
The dark count spectra allow for the study of the SPE response dependence on the working parameters, i.e. MaPMT
...
depends on the quality of the photocathode. The plateau is a consequence of the saturated 
...
level. The flow is set to about 40~l/m to ensure a complete inner volume exchange every few hours. 
...
\begin{figure}
\begin{center}
\includegraphics[width=0.45\textwidth]{mirror_spot1.png}
\includegraphics[width=0.45\textwidth]{mirror_spot2.png}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.45\textwidth]{mirror_before.png}
\includegraphics[width=0.45\textwidth]{mirror_after.png}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.45\textwidth]{mirrors.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.45\textwidth]{MaPMT.pdf}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.95\columnwidth]{pedestal_rms_before.png}
\includegraphics[width=0.95\columnwidth]{pedestal_rms_after.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.95\columnwidth]{SPEdark.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.95\columnwidth]{PedestalMeanVariation.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.95\columnwidth]{Pedestal_map.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.95\columnwidth]{Darkcount_map.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.95\columnwidth]{xtalk.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.95\columnwidth]{ckmaca.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.95\columnwidth]{Tracking_time.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.95\columnwidth]{dt_vs_anode_nocor.png}
\includegraphics[width=0.95\columnwidth]{dt_vs_dur_nocor.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.9\columnwidth]{time_walk_fit2.png}
\includegraphics[width=0.9\columnwidth]{Saturation_ToT3.png}
\end{center}
...
\begin{figure*}[!ht]
\begin{center}
\includegraphics[width=1.7\columnwidth]{Event_21488.png}
\end{center}
...
\begin{figure*}[!ht]
\begin{center}
\includegraphics[width=1.7\columnwidth]{Event_13051.png}
\end{center}
...
\begin{figure*}[!ht]
\begin{center}
\includegraphics[width=1.7\columnwidth]{Event_11846.png}
\end{center}
...
\begin{figure*}[!ht]
\begin{center}
\includegraphics[width=1.7\columnwidth]{Event_20155.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.9\columnwidth]{Tile12_rms_plot2.png}
\end{center}
...
After alignment, the resolution improves toward
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.9\columnwidth]{Electron_PID.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.9\columnwidth]{Hadron_PID.png}
\end{center}
...
\includegraphics[width=0.9\columnwidth]{mass_vs_mom.png}
\end{center}
...
at CLAS12 in the 3 to 8 GeV momentum range. It substitutes the baseline LTCC gas threshold Cherenkov detector 
...
To efficiently cover the desired few-GeV momentum range, the RICH employs 
...
\bibitem{TBP} P. Degtiarenko, V. Kubarovsky, A. Kim, and A. Smith, to be published.
