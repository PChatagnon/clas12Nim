\begin{abstract}
The CEBAF Large Acceptance Spectrometer at 12~GeV
(CLAS12) is located in Hall~B, one of the experimental halls at Jefferson Lab.  
The forward part of CLAS12 is built around a superconducting toroidal magnet. 
The six coils of the toroid divide the detector azimuthally into six sectors.  
Each sector contains three multi-layer 
...
superlayers oriented at $\pm 6^{\circ}$ stereo angles. Each layer has 112 hexagonal cells
...
of the efficiency and resolution are presented from in-beam measurements.
\end{abstract}
