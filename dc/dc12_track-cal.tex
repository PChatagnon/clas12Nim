...
\end{picture}
\caption{\small{A plot of TRKDOCA vs. time from our track fits. Over-plotted in darker symbols
...
Figure~\ref{resids-vs-layer-before} plots the mean of the residuals of a straight-line
fit to the tracks vs. layer (1 - 36 layers of the chambers) for one sector (in this
...
\end{picture}
\caption{\small{A plot of the fit residual mean vs. layer for the Sector~1 drift chambers before (red squares) and
    after (blue crosses) alignment.  The displacements occur in correlated groups, layers (1-12, 13-24, and 25-36),
...
Figure~\ref{resids-vs-layer-after} shows the shifts of the means for all sectors that remain after we have
aligned the chambers. The RMS deviations of the means from zero average to about 50~$\mu$m.
...
\caption{\small{Plots of the fit residual mean vs. layer, before alignment (red squares) and after alignment (blue
    crosses), for each of the six sectors.
}}
