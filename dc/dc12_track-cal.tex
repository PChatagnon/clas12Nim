...
\end{picture}
\caption{\small{A plot of (Bmodel - Bmeasured) / Bmodel vs. $z$ (along the beamline) for the 160 measurement
points within one sector (Sec1) of the torus magnet.  Sub-figure A was for measurements at a radius
of 30 cm and a $\Phi$ of $0^{circ}$ (on the midplane).  Sub-figures B, C, and D were taken at a radius
