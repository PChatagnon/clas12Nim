...
The time window  of the SVT is set to to 128~ns: all Geant4 steps within the same strip and time window are collected
in one hit.
...
15 years. The results of the study are summarized in \F{radStudy}.
