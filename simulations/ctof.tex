...
The CLAS12 CTOF paddles and light guides (see \F{ctofGeometry} top) are imported from the engineering model.
...
such as the shape of the scintillator/light guide junctions, see \F{ctofGeometry} bottom.
