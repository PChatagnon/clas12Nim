...
The solenoid magnet geometry is produced with the GEMC perl API. The solenoid is a single Geant4 polycone volume, shown in \F{solenoid}.
\begin{figure}[h]
	\centering
...
%diameter and 40~mm long cylindrical volume.
