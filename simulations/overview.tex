...
\begin{itemize}
    ...
    \item the Time-to-Digitcal Counter (TDC) value: this represents the time of the hit in the channel relative
    ...
    \item one single value of TDC for each hit, extrapolated from the FADC voltage distribution by considering channgel
...
the FADC. An example of a simulated vs data FADC signal is given in \F{fadcComparison}.
