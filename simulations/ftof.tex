...
The corrected energy is converted to the number of photons $N_{th}$ using the constant 500 photons/MeV, which was
...
ADC for the right paddles as a function of hit position is shown in \F{ftofAtten}.
