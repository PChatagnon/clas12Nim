...
\subsection{Reconstruction of $\pi^0 \to \gamma \gamma$ Decays}
...
From Eq.~\ref{eq:ivm} the following expression for the invariant mass resolution can be derived, expressed in
