\subsection{PMT Voltage Dividers}\label{sec:dividers}
...
was built to provide a factor of ten amplification and a split signal directly from the PMT base.
...
\begin{figure*}
	...
	\caption{Left: schematic of the PMT amplifier board, shown as a resistor chain for simplicity. The amplifier,
          ...
          bottom of the base has been modified to contain the HV SHV input and two output signals.}
