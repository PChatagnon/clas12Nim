...
and 400~nm was designed (see \F{wcSetup}) to accept shallow incident angles of 10\mdeg-15\mdeg (typical angles
based on simulation studies). The typical reflectivity of a poor WC vs. wavelength is shown in \F{wcStatusBefore}
...
summarized in \F{wcStatusAfter} (bottom).
