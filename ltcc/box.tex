...
of the LTCC vessel had to be modified from the original cylindrical to a flat profile, see \F{boxCut}. As a consequence of such
...
\begin{figure}[ht]
	...
	\caption{The refurbished LTCC box frame. Originally the frame walls spanned a portion of the surface of a 5~m
          ...
          to the gas radiator thickness increase detailed on \F{noseVolume}. }
	\label{fig:boxCut}
\end{figure}
...
addition, a ``nose'' support (see \F{boxCut}) has been engineered to increase the gas volume. The nose dimensions have
been optimized to provide the necessary support, while at the same time, maximizing the gas volume increase. The gas
volume increase of the final configuration is shown in \F{noseVolume}.
...
The new light-weight back-wall design is shown in \F{backWall}. The wall is supported by stainless steel bars that enclose a panel
...
A new carbon fiber spine, see \F{spine},
