...
\F{electronEfficiency}, along with the fit using a constant up to 7~GeV. The average efficiency for detection of
...
\F{pionMomentum} (bottom). The LTCC response starts around 50\% near the expected signal threshold of
