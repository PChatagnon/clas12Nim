\begin{abstract}
  ...
  and photomultipliers. The design, construction, and performance of the refurbished LTCC are described. The
  ...
  photoelectrons in the response signal. The LTCC response calibration has been performed on the single
  photoelectron signals, and the system efficiencies and response functions have been measured.
\end{abstract}
