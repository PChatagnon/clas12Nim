...
\author{V.D. Burkert, L. Elouadrhiri, D. Anderson, S. Aune, H. Avakian, N. Baltzell, M. Battaglieri,  V. Baturin,
  S. Boiarinov, F. Bossu, K. Bruhwel, D.S. Carman, S. Christo, A. Celentano, M. Contalbrigo,  C. Cuevas, N. Dashyan,
  M. Defurne, G. Dodge, R. De Vita, R. Fair, K. Giovanetti, F.X. Girod, K. Griffioen, R. Gothe, Y. Gotra, K. Hafidi, T. Hayward, 
  D. Heddle, P. Hemler, K. Hicks, D. Insley, K. Joo, D. Kashy, C. Keith, A. Kim, W. Kim, V. Kubarovsky, S. Kuhn, A. Lung,
  M. McMullen, I. Mandjavidze, N. Markov, C. Mealer, M.D. Mestayer, Z.E. Meziani, R. Miller, M. Mirazita, V. Mokeev,
  J. Newton, S. Niccolai, R. Paremuzyan, O. Pastor, E. Pasyuk, O. Pogorelko, B.A. Raue, P. Rossi, F. Sabatie, Y.G. Sharabian,
  L.C. Smith, D. Sokhan, J. A. Tan, D. Tilles, M. Ungaro, A. Vlassov, D. Watts, L. Weinstein, C. Wiggins, A. Yegneswaran,
  G. Young, M. Zarecky, V. Ziegler, ......... more coming .............}
...
\caption{Combined solenoid and torus magnetic fields. The color code shows the total magnetic field of both
...
FT is active and all channels are turned on. In this case, a thinner beam-pipe shield is installed to allow the FT to
accept particles down to 2.5$^\circ$. Further details on the FT are described in Ref.~\cite{FT}. Figure~\ref{ft}
shows a rendering of the FT setup near the entrance to the warm bore of the torus magnet.   
