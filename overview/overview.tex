...
\caption{Combined solenoid and torus magnetic fields, showing the magnetic field component perpendicular 
...
\begin{figure*}[t!]
%\centerline{\includegraphics[width=0.95\columnwidth]{neg-tracks.png}}
...
\caption{Particle distributions in azimuthal angle (degrees) vs momentum in the CLAS12 FD for electrons (top) and for positive
 tracks (bottom) at a beam energy of 10.6 GeV.  The azimuthal angle is measured at the production vertex. The momentum dependence is due to
  the solenoidal magnetic field that rotates charged tracks dependent on their transverse momentum component
  and charge. For positive tracks the azimuthal motion is in the opposite direction from negative (electron) tracks.} 
\label{neg-pos}
\end{figure*}
...
\caption{Distributions of scattered electrons in azimuthal angle (in deg.) for different bins in polar
  ...
  sector range of $\pm 30^\circ$. Azimuthal angle coverage is symmetric around the sector mid-plane ay 0. The
  ...
  50\% in azimuthal angle, see Fig.~\ref{coil-mount}. Vertical axes are in arbitrary units. {\bf Requested 
...
sign. Figure~\ref{e-accept} shows accepted azimuthal range at 3 different polar angles for electrons bending away
