...
\author{V.D. Burkert, L. Elouadrhiri, D. Anderson, S. Aune, H. Avakian, N. Baltzell, M. Battaglieri,  V. Baturin,
  S. Boiarinov, F. Bossu, K. Bruhwel, D.S. Carman, S. Christo, A. Celentano, M. Contalbrigo,  C. Cuevas, N. Dashyan, M. Defurne, G. Dodge, R. De Vita, R. Fair, K. Giovanetti, F.X. Girod, K. Griffioen, R. Gothe, Y. Gotra, K. Hafidi, T. Hayward, 
  D. Heddle, P. Hemler, K. Hicks, D. Insley, K. Joo, D. Kashy, C. Keith, A. Kim, W. Kim, V. Kubarovsky, S. Kuhn, A. Lung, M. McMullen, I. Mandjavidze, N. Markov, C. Mealer, M.D. Mestayer, Z.E. Meziani, R. Miller, M. Mirazita, V. Mokeev, J. Newton, S. Niccolai, R. Paremuzyan, O. Pastor, R. E. Pasyuk, O. Pogorelko, B. Raue, P. Rossi, F. Sabatie, Y. Sharabian, L.C. Smith, D. Sokhan, S. Stepanyan, J. A. Tan, D. Tilles, M. Ungaro, A. Vlassov, D. Watts, L. Weinstein, C. Wiggins, A. Yegneswaran, G. Young, M. Zarecky, V. Ziegler, {\bf incomplete list} ......... more coming .............}
...
the United States Department of Energy. An international collaboration of over 40 institutions contributed to the design and
...
broad science program addressing fundamental issues in nuclear and hadronic physics. In Hall~D, a large hermetic detector with a solenoid magnet
...
\begin{figure*}[h!]
\vspace{0.5cm}%\centerline{\includegraphics[width=0.95\columnwidth]{neg-tracks.png}}
...
\begin{table*}[t!]
\caption{CLAS12 approximate performance parameters.  {\bf Need to check resolutions with results from the data analysis}}    
...
\bibitem{GEMC-background} V. Burkert, S. Stepanyan, J. A. Tan, and M. Ungaro, CLAS12 Note 2017-018, 
