...
\author{V.D. Burkert, L. Elouadrhiri, D. Anderson, S. Aune, H. Avakian, N. Baltzell, M. Battaglieri,  V. Baturin,
  ...
  R. De Vita, R. Fair, K. Giovanetti, F.X. Girod, L. Guo, R. Gothe, Y. Gotra, K. Hafidi, D. Heddle, P. Hemler, K. Hicks, D. Insley,
...
other, and are tilted forward at a $22^\circ$ angle relative to the vertical. The bores at the outer two corners
...
\hspace{1cm}\includegraphics[width=0.85\columnwidth]{neg_phi_p-out.png}}
\caption{(Color Online) Particle distributions in azimuthal angle ($\phi$) vs momentum in the CLAS12 FD for inbending electrons  (left) and for outbending tracks (right) at a beam energy of 10.6 GeV.  The azimuthal angle is measured at the production vertex. The azimuthal distribution of electrons 
...
\label{rich-event}
\vspace{0.3cm}\centerline{\includegraphics[width=1.0\columnwidth]{mass_min3.pdf}}
