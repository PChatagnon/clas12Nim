...
matching windows. {\color{red}\sout{ In each of the sectors of the CLAS12 Forward Detector there are three FTOF counter arrays. In
...
algorithm looks to define hit clusters matched to tracks separately in each of {\color{red} the} counter arrays.
